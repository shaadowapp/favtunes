...
fun RecentlyPlayedScreen(
    ...
    val displaySongs = if (recentSongs.isEmpty()) fallbackSongs else recentSongs
    ...
    ScreenIdentifier(
        screenId = "recently_played",
        screenName = "Recently Played Screen"
    )
                ...
                FloatingActionButton(
                    onClick = {
                        ...
                        binder?.player?.forcePlayFromBeginning(
                            displaySongs.shuffled().map(Song::asMediaItem)
                        )
                    },
                        ...
                        LocalSongItem(
                            ...
                            onClick = {
                                ...
                                binder?.player?.forcePlayAtIndex(
                                    displaySongs.map(Song::asMediaItem),
                                    index
                                )
                            },
                            onLongClick = {
